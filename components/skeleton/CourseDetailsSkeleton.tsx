    ...
    >
      <div className="mx-auto flex max-w-[1100px] flex-col gap-8 px-6 py-8 md:flex-row md:items-start">
        <main className="min-w-0 flex-1">
          <div className={`${shimmer} mb-5 h-5 w-32`} />
          ...
          <section className="relative aspect-[16/7] overflow-hidden rounded-[10px] border border-[#eadfd4] bg-[#f8f0e8] shadow-[0_18px_45px_rgba(63,52,44,0.08)]">
            ...
            <div className="absolute bottom-5 left-5 h-9 w-32 animate-pulse rounded-full bg-white/90" />
          </section>

          <section className="mt-6">
            <div className={`${shimmer} h-9 w-full max-w-xl`} />
            <div className={`${shimmer} mt-3 h-4 w-full max-w-2xl`} />
            <div className={`${shimmer} mt-2 h-4 w-5/6 max-w-xl`} />
          ...
          <section className="mt-8">
            ...
            <div className={`${shimmer} mt-5 h-5 w-24`} />
              ...
              {[0, 1, 2].map((chapter) => (
                ...
                >
                  <div className="flex w-full items-center gap-3 bg-[#f8f0e8] px-4 py-[14px]">
                    ...
                    <div className={`${shimmer} hidden h-4 w-20 sm:block`} />
                    <div className={`${shimmer} h-5 w-5 rounded-[4px]`} />
                  </div>
                  ...
                  {chapter === 0 && (
                    <div className="border-t border-[#eadfd4]">
                      {[0, 1, 2].map((lesson) => (
                        ...
                        >
                          <div className="h-4 w-4 shrink-0 animate-pulse rounded-full bg-[#eadfd4]" />
                          <div className="min-w-0 flex-1">
        ...
        <aside className="h-fit w-full rounded-[10px] border border-[#eadfd4] bg-white p-5 shadow-[0_18px_45px_rgba(63,52,44,0.08)] md:sticky md:top-4 md:w-[300px] md:shrink-0">
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 flex flex-col gap-4">
              {[0, 1, 2, 3].map((item) => (
                <div key={item} className="flex items-center gap-3">
                  <div className={`${shimmer} h-4 w-4 shrink-0 rounded-[4px]`} />
          ...
          <div className="mt-6 h-11 w-full animate-pulse rounded-[8px] bg-[#8f6249]/40" />
          <div className={`${shimmer} mx-auto mt-3 h-3 w-40`} />
        </aside>
      </div>
    </div>
  );
