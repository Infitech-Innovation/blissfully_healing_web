      ...
      <div className="relative flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="space-y-2.5">
          <div className="flex items-center gap-2">
            <Badge className="border-[#eadfd4] bg-[#fffaf6] text-[#8f6249] hover:bg-[#fffaf6] text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-[4px]">
        ...
        <div className="flex items-center gap-4 sm:flex-col sm:items-end sm:gap-2.5">
          ...
          <div className="text-left sm:text-right">
            <p className="text-[10px] font-bold uppercase tracking-widest text-[#b39c8c]">
              Status
            </p>
            <p className="text-xs font-semibold text-[#6f5c4f] mt-0.5">
              Active
            </p>
          </div>
        </div>
