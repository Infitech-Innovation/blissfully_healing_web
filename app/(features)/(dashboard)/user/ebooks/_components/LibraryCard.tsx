          ...
          >
            ...
            <div className="mt-auto flex flex-col sm:flex-row gap-3">
              ...
              <Link
                ...
                className="flex flex-1 items-center justify-center gap-2 rounded-[8px] border border-[#eadfd4] bg-white px-4 py-3 text-xs font-bold uppercase tracking-widest text-[#6f5c4f] transition hover:border-[#8f6249] hover:text-[#8f6249]"
              >
                <BookOpen size={14} />
                Open Web Reader
              </Link>
