        ...
        <div className="mb-14 flex flex-col justify-between gap-6 md:flex-row md:items-end">
          ...
          <div className="md:max-w-xs">
            <p className="mb-4 text-sm leading-7 text-[#6f5c4f]">
              From private renewal to group sanctuary, each retreat is shaped for
              rest, emotional spaciousness, and grounded integration.
            </p>
            <button className="rounded-[8px] border border-[#eadfd4] bg-white px-6 py-3 text-xs font-bold uppercase tracking-widest text-[#6f5c4f] transition hover:border-[#8f6249] hover:text-[#8f6249]">
              View All Retreats
            </button>
          </div>
        </div>
