...
export default function Temples() {
  return (
    <div className={`${manrope.className} bg-[#fbf7ef] text-[#2a211c]`}>
      ...
      <section
        className="mx-auto w-[min(1220px,90vw)] pb-28 md:pb-36"
        id="temples"
      >
        {temples.map((temple, index) => {
          ...
          return (
            <article
              className={`grid min-h-[580px] items-center gap-10 border-t border-[#b99a60]/25 py-16 md:gap-[5vw] md:py-20 ${
                reverse
            ...
            >
              <div className={reverse ? "md:order-2" : ""}>
                <div
                  className={`${cormorantGaramond.className} text-[7rem] font-semibold leading-none opacity-20`}
